...
function easyweb_webnus_setup_framework_options() {
    ...
    $sections[] = array(
        ...
        'fields' => array(
            ...
            array(
                'id' => 'easyweb_webnus_polylang_flags',
                'type' => 'button_set',
                'title' => esc_html__('Enable Flags (polylang)', 'easyweb'),
                'options' => array('' => esc_html__('None', 'easyweb'), 'left' => esc_html__('Left', 'easyweb'), 'right' => esc_html__('Right', 'easyweb')),
                'desc' => wp_kses( __('<br>Enable Polylang Flags in Topbar','easyweb'), array( 'br' => array() ) ),
                'std' => ''
            ),          
