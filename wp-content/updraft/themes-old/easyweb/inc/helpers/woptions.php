...
if (!class_exists('easyweb_webnus_options')) {
	class easyweb_webnus_options {
		...
		static public function easyweb_webnus_polylang_flags() {
			$thm_options = get_option('easyweb_webnus_options');
			return isset($thm_options['easyweb_webnus_polylang_flags']) ? $thm_options['easyweb_webnus_polylang_flags'] : null;
		}
